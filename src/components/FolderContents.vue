    ...
    <div class="contents-container">
      <div class="contents-wrapper">
        ...
        <div v-show="listType === 'list'" style="min-height: 100%;">
          ...
          >
            <q-tr
              :id="props.row.nodeKey"
              slot="body"
              slot-scope="props"
              :props="props"
              @click.native.stop="rowClick(props.row)"
              @dblclick.native.stop="dblRowClick(props.row)"
            ...
            >
              ...
              >
                <img
                  v-if="props.row.data.isDir"
                  :size="imageWidth + 'px'"
                  :width="imageWidth + 'px'"
                  src="statics/images/folder.png"
                />
                <grid-item-image v-else :node="props.row" :width="imageWidth" />
              </q-td>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          sortable: true,
          sort: (a, b) =>
            parseFloat(a.stat.mtimeMs) - parseFloat(b.stat.mtimeMs)
        }
      ],
      pagination: {
        page: 1,
